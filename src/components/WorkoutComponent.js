...
import useMuscleImage from './utils/useMuscleImage';
...
export default (props) => {
    ...
    return (
        <Workout>
                ...
                <MuscleScroll horizontal={true}>
                    {muscleGroups.map((m, index) => (
                        <MuscleGroup key={index} >
                            <MuscleIcon source={useMuscleImage(m)}></MuscleIcon>
                        </MuscleGroup>
                    ))}
                </MuscleScroll>
            </WorkoutInfo>
            <WorkoutActions>
                <WorkoutButton>
                    <WorkoutIcon source={require('../assets/add.png')}></WorkoutIcon>
                </WorkoutButton>
            </WorkoutActions>
        </Workout >
    );
